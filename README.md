...
The research arc progresses across five evaluation frameworks:

CDCT → DDFT → AGT → CGAE → Comprehension-Gated Capability Growth
...
### CGAE : Comprehension-Gated Agent Economy (2026)
A decentralized protocol for verifiable agentic reasoning and on-chain capability gating.  
arXiv: [https://arxiv.org/abs/2603.15639]
